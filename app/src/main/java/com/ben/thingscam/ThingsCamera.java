 ...
 */
public class ThingsCamera {
    private static final String TAG = ThingsCamera.class.getSimpleName();
    ...
    private ThingsCamera() {
    }

    private static class InstanceHolder {
        private static ThingsCamera mCamera = new ThingsCamera();
    }

    public static ThingsCamera getInstance() {
